...
export default function AddComponentScreen({ navigation }) {
    ...
    /**
     * Primero valida que los campos requeridos (nombre, tipo, estado) estén completos.
     * Luego limpia la lista de descripciones para mantener solo el nombre y la descripción de cada una.
     * Envía una solicitud POST al backend con los datos del nuevo componente, incluyendo el token JWT desde AsyncStorage.
     * Si la creación es exitosa, resetea el formulario y muestra una alerta de éxito.
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.formBox}>
                ...
                {/* Lista de características ya agregadas */}
                <ScrollView
            ...
            {/* Modal para ingresar nombre y descripción de una característica */}
            <Modal
